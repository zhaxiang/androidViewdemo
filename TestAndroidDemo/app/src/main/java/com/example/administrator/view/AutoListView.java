...
public class AutoListView extends ListView implements AbsListView.OnScrollListener
{
    ...
    //区分PULL和RELEASE的距离大小
    private static final int SPACE_DISTANCE = 20;
    ...
    private boolean loadEnable = true;//开启和关闭加载更多功能
    ...
    private void refreshHeaderViewByState() {
        switch (state) {
            case NONE:
                topPadding(-headerContentHeight);
                tip.setText("pull_to_refresh");
                refreshing.setVisibility(View.GONE);
                arrow.clearAnimation();
                arrow.setImageResource(R.drawable.pull_arrow);
                break;
            case PULL:
            ...
            case RELEASE:
                ...
                lastUpdate.setVisibility(View.VISIBLE);
                refreshing.setVisibility(View.GONE);
                tip.setText("release_to_refresh");
                arrow.clearAnimation();
        ...
        switch (state)
        {
            ...
            case PULL:
                ...
                if (scrollState == SCROLL_STATE_TOUCH_SCROLL
                        && space > headerContentHeight + SPACE_DISTANCE)
                {
                    state = RELEASE;
                    refreshHeaderViewByState();
                }
            ...
            case RELEASE:
                topPadding(topPadding);
                if (space > 0 && space < headerContentHeight + SPACE_DISTANCE)
                {
                    state = PULL;
                    refreshHeaderViewByState();
                } else if (space <= 0) {
